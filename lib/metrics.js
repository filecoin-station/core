...
export class Metrics {
  ...
  getMetricsFilePath (module) {
    return module
      ? join(this.core.paths.metrics, `${module}.log`)
      : this.core.paths.allMetrics
  }
  ...
  async createWriteStream (moduleName) {
    ...
    splitStream
      ...
      .pipe(
        this.core.logs.createWriteStream(
          join(this.core.paths.metrics, `${moduleName}.log`)
        )
      )
    splitStream
      ...
      .pipe(new SerializeStream())
      .pipe(this.core.logs.createWriteStream(this.core.paths.allMetrics))
