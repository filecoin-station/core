...
export class Logs {
  ...
  getLogFilePath (module) {
    return module
      ? join(this.core.paths.moduleLogs, `${module}.log`)
      : this.core.paths.allLogs
  }
   ...
   */
  async get (module) {
    return await fs.readFile(this.getLogFilePath(module))
  }
  ...
  createWriteStream (path) {
    ...
    logStream
      ...
      .pipe(createSingleLogStream(this.core.paths.allLogs))
